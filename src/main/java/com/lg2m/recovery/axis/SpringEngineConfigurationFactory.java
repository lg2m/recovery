package com.lg2m.recovery.axis;
...
public class SpringEngineConfigurationFactory extends EngineConfigurationFactoryDefault {
    ...
    public static org.apache.axis.EngineConfigurationFactory newFactory(Object param) {
        ...
        return (param instanceof ServletConfig)
                ? new SpringEngineConfigurationFactory((ServletConfig) param)
                : null;
    }

    protected SpringEngineConfigurationFactory(ServletConfig cfg) {
        super();
        this.cfg = cfg;
    }
